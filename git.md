...
Здесь мы видим, что к нашему проекту подключен один удаленный репозиторий, `origin` - название по-умолчанию, это лишь псевдоним (alias) для репозитория `https://domain.com:work/project.git`. Почему две строчки, если проект один? Git предоставляет работу в двух направлениях - читать и писать в репозиторий,
...
git remote add origin https://domain.com:work/project.git
```
Если все прошло успешно мы сможем читать и писать в удаленный репозиторий `origin`, который находится по адресу https://domain.com:work/project.git.
